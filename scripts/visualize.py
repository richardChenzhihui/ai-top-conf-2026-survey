...
<div class="hero">
  ...
  <p>基于关键词分类，覆盖 CVPR 2026 / ICLR 2026 / NeurIPS 2025 全量论文</p>
  <div class="stat-row">
"""]
    for conf in CONFS:
...
""")
    ...
    html_parts.append("<footer>Generated by classify_keywords.py + visualize.py · 数据来源：CVPR虚拟站、OpenReview API</footer></body></html>")
